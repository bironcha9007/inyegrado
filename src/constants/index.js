...
export const AboutPart = [
    {
        ...
        link: '/servicios/9',
        title: "PEI",
        text: "El Proyecto Educativo Institucional (PEI) es la esencia de nuestro colegio, unificando valores, estrategias pedagógicas y metas académicas. Es el marco que guía el desarrollo integral de nuestros estudiantes hacia la excelencia y la ciudadanía responsable.",
    },
    {
        id: 2,
        image: image24,
        ...
        link: '/servicios/9',
        text: "Nuestro Gobierno Escolar fomenta la participación activa de estudiantes, padres y docentes, promoviendo la democracia, el liderazgo y el sentido de pertenencia. Es un pilar clave en la formación de ciudadanos comprometidos con su comunidad.",
    },
    {
        id: 3,
        image: image25,
        ...
        link: '/servicios/8',
        text: "Con 56 años de historia, nuestro colegio es testigo de generaciones de estudiantes que han transformado sueños en logros. Nuestra tradición educativa está marcada por el compromiso con la calidad y la innovación constante.",
    },
];
